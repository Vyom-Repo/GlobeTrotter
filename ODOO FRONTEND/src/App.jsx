...
export function App() {
  const [currentScreen, setCurrentScreen] = useState('screen6'); // 'screen6' | 'screen6-detail' | 'screen4' | 'screen5' | 'screen7' | 'screen8' | 'screen9' | 'screen10'
  ...
  // Add activity from Screen 08 directly into the active trip
