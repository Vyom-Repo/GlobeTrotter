...
import {
  User, Mail, Phone, MapPin, Camera, Save, Check, ShieldAlert, Globe, DollarSign, X, ArrowLeft, Heart, CheckCircle2, Award, Sparkles, Share2, Compass, ArrowRight, Plane, LogOut, Shield
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-surface-canvas pb-24">
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div onClick={() => setIsDeleteModalOpen(false)} className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-40" />
